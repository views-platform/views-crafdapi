...
class LoggingModule:
    ...
    def __init__(self, logging_path):
        ...
        self._logging_path = Path(logging_path)
    ...
    def _load_logging_config(self) -> dict:
        ...
        in the 'views_crafdapi.configs' package and returns it as a dictionary.

        Returns:
            dict: The logging configuration.
        """
        try:
            with importlib.resources.files("views_crafdapi.configs").joinpath(
                "logging.yaml"
            ).open("r") as file:
