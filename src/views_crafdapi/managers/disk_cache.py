...
churns with the class signature (C-138). Extracted from CrafdApiManager (C-36).
"""
...
def _derive_cache_schema_version() -> int:
    ...
    module (the S11 SDP-inversion fix). Decoupled from `ForecastDataset.__init__`'s
