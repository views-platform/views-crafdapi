...
from views_faoapi.version import version_info
...
from views_faoapi.managers.serialization import (  # noqa: E402
    dataframe_to_dict,
    parse_list_param,
    parse_string_list_param,
)
from views_faoapi.forecast.serialize.json_contract import to_consumer_columns  # noqa: E402
from views_faoapi.forecast.serialize.bulk_parquet import write_bulk_parquet  # noqa: E402
...
class FAOApiManager(APIManager):
    ...
    def __init__(
        ...
        self._disk_cache = FAODiskCacheManager(self._model_path.cache / "datasets")
    ...
    def from_config(
        ...
        *,
        ...
        """Create a FAOApiManager from a pre-built config dict, bypassing filesystem config discovery.
        ...
        instance._disk_cache = FAODiskCacheManager(cache_dir)
    ...
    def _startup(self):
        ...
        try:
            ...
            if workers > 1 or reload_enabled:
                ...
                uvicorn.run(
                    "views_faoapi.managers.api:create_app",
    ...
    def _shutdown(self):
        ...
        try:
            ...
            # `FAODiskCacheManager` (cache/datasets/) is a durable, 3.5-week
...
_fao_manager: Optional[FAOApiManager] = None
...
def create_app() -> FastAPI:
    ...
    if app is None:
        ...
        # FAODiskCacheManager (`None / "datasets"`). validate=False makes .cache a real
        ...
        _fao_manager = FAOApiManager(model_path=model_path)
