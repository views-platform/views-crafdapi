...
The views-faoapi project serves critical conflict forecast data from the VIEWS platform to the UN FAO. It involves long-lived code, evolving statistical methods, operational constraints around geographic aggregation and prediction delivery, and multiple contributors with different roles and time horizons.
...
The ADR template is located at `docs/ADRs/templates/adr_template.md`.
...
- `docs/ADRs/templates/adr_template.md`
